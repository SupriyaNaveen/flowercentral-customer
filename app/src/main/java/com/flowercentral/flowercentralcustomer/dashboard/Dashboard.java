...
public class Dashboard extends BaseActivity
    ...
    private void preparingProductList(){
        ...
        p1.setImage ("https://i6.fnp.com/images/pr/s/splendid-purple-orchids-standard_1.jpg");
        p1.setPrice (700d);
        p1.setLiked (1);
        ...
        p2.setImage ("https://i6.fnp.com/images/pr/s/splendid-purple-orchids-standard_1.jpg");
        p2.setPrice (700d);
        p2.setLiked (0);
        mProductList.add (p2);
        ...
        p3.setImage ("https://i6.fnp.com/images/pr/s/splendid-purple-orchids-standard_1.jpg");
        p3.setPrice (700d);
        p3.setLiked (1);
        mProductList.add (p3);
        ...
        p4.setImage ("https://i6.fnp.com/images/pr/s/splendid-purple-orchids-standard_1.jpg");
        p4.setPrice (700d);
        p4.setLiked (1);
        mProductList.add (p4);
        ...
        p5.setImage ("https://i6.fnp.com/images/pr/s/splendid-purple-orchids-standard_1.jpg");
        p5.setPrice (700d);
        p5.setLiked (0);
        mProductList.add (p5);
        ...
        p6.setImage ("https://i6.fnp.com/images/pr/s/splendid-purple-orchids-standard_1.jpg");
        p6.setPrice (700d);
        p6.setLiked (1);
        mProductList.add (p6);
        ...
        p7.setImage ("https://i6.fnp.com/images/pr/s/splendid-purple-orchids-standard_1.jpg");
        p7.setPrice (700d);
        p7.setLiked (0);
        mProductList.add (p7);
        ...
        p8.setImage ("https://i6.fnp.com/images/pr/s/splendid-purple-orchids-standard_1.jpg");
        p8.setPrice (700d);
        p8.setLiked (0);
        mProductList.add (p8);
